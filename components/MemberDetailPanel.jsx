((global) => {
  const namespace = global.FamilyTreeComponents ||
    (global.FamilyTreeComponents = {});
  const { CloseIcon } = global.FamilyTreeIcons;
  ...
  namespace.MemberDetailPanel = MemberDetailPanel;
})(window);
